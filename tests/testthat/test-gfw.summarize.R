...
test_that("the right summary is performed and returned", {
  expected.summary = read.csv("./files/summarized.catch.mmsi.csv", check.names=FALSE) # the downloaded csv has user friendly spaces in its colnames, which would be converted into dots
